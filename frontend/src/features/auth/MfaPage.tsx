...
export function MfaPage() {
  ...
  async function onSubmit(values: MfaValues) { try { setFormError(""); await verifyMfa(values.code); navigate(location.state?.from ?? "/dashboard", { replace: true }); } catch (error) { setFormError(error instanceof Error ? error.message : "Código inválido."); } }
