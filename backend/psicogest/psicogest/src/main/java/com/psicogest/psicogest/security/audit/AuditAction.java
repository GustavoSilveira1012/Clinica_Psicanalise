...
public enum AuditAction {
    ...
    /**
     * 37. Eventos de notificações.
     *
     * Metadados permitidos: IDs, canal, provider, status, códigos de erro,
     * hashes e contagens. Nunca registrar body completo, telefone ou e-mail
     * completo; contatos devem ser omitidos, mascarados ou representados por
     * hash quando houver necessidade operacional.
     */
    ...
    NOTIFICATION_PROVIDER_CONFIGURATION_CHANGED,
    ...
    SAAS_SUBSCRIPTION_RESTRICTED,
    SAAS_BILLING_INVOICE_CREATED,
    SAAS_BILLING_INVOICE_PAID,
