...
@Entity
@Table(
        name = "therapeutic_relationships",
        indexes = {
                @Index(
                        name = "idx_therapeutic_relationship_patient",
                        columnList = "patient_id"
                ),
                @Index(
                        name = "idx_therapeutic_relationship_psychoanalyst",
                        columnList = "psychoanalyst_id"
                )
        }
)
@Getter
